...
export const realityUpgrades = [
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ETERNITY_RESET_AFTER,
    canLock: true,
    lockEvent: "제4 TD보다 높은 시간 차원 구매",
    description: () => `영원 자동 구매기를 개선하고 시간 차원 및 ${formatX(5)} EP 자동 구매기 해금`,
    automatorPoints: 10,
    shortDescription: () => `TD 및 ${formatX(5)} EP 자동 구매기, 영원 자동 구매기 개선`,
  },
  {
    name: "영원한 흐름",
    id: 14,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ETERNITY_RESET_AFTER,
    canLock: true,
    lockEvent: () => `${formatX(5)} EP 업그레이드 구매`,
  ...
  },
  {
    ...
    id: 22,
    cost: 100000,
    requirement: () => `시간 조각 ${format(Currency.timeShards.value, 1)}/${format(DC.E28000)}`,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ETERNITY_RESET_AFTER,
    description: "현실 자동 구매기 및 오토메이터 명령어 해금",
    automatorPoints: 100,
    shortDescription: () => `현실 자동 구매기`,
  },
];
