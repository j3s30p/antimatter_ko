...
export const eternityUpgrades = {
  idMultEP: {
    id: 1,
    cost: 5,
    description: () => `사용하지 않은 영원 포인트에 따라 무한 차원에 배율 적용 (x+${formatInt(1)})`,
  ...
  idMultEternities: {
    id: 2,
    cost: 10,
    description: () => `영원 횟수에 따라 무한 차원에 배율 적용
  ...
  idMultICRecords: {
    id: 3,
    cost: 5e4,
    description: "무한 도전 완료 시간의 합에 따라 무한 차원에 배율 적용",
  ...
  tdMultAchs: {
    id: 4,
    cost: 1e16,
    description: "도전과제 보너스가 시간 차원에도 적용",
  ...
  tdMultTheorems: {
    id: 5,
    cost: 1e40,
    description: "사용하지 않은 시간 정리 수만큼 시간 차원에 배율 적용",
  ...
  tdMultRealTime: {
    ...
    description: () => (Pelle.isDoomed
      ? "이번 아마겟돈에서 플레이한 일수만큼 시간 차원에 배율 적용"
      : "플레이한 일수만큼 시간 차원에 배율 적용"
    ),
