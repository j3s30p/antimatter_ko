...
export const pelleUpgrades = {
  ...
  antimatterDimAutobuyers1: {
    id: 0,
    description: "반물질 차원 1-4의 자동 구매기를 영구적으로 획득합니다",
    cost: 1e5,
    formatCost,
  },
  dimBoostAutobuyer: {
    id: 1,
    description: "차원 가속 자동 구매기를 영구적으로 획득합니다",
    cost: 5e5,
    formatCost,
  },
  keepAutobuyers: {
    id: 2,
    description: "아마겟돈 시 자동 구매기 업그레이드가 더 이상 초기화되지 않습니다",
    cost: 5e6,
    formatCost,
  },
  antimatterDimAutobuyers2: {
    id: 3,
    description: "반물질 차원 5-8의 자동 구매기를 영구적으로 획득합니다",
    cost: 2.5e7,
    formatCost,
  },
  galaxyAutobuyer: {
    id: 4,
    description: "반물질 은하 자동 구매기를 영구적으로 획득합니다",
    cost: 1e8,
    formatCost,
  },
  tickspeedAutobuyer: {
    id: 5,
    description: "틱스피드 업그레이드 자동 구매기를 영구적으로 획득합니다",
    cost: 1e9,
    formatCost,
  },
  ...
  IDAutobuyers: {
    id: 9,
    description: "무한 차원 자동 구매기를 영구적으로 획득합니다",
    cost: 1e14,
    formatCost,
  },
  ...
  replicantiAutobuyers: {
    id: 12,
    description: "복제자 업그레이드 자동 구매기를 영구적으로 획득합니다",
    cost: 1e17,
    formatCost,
  },
  ...
  TDAutobuyers: {
    id: 18,
    description: "시간 차원 자동 구매기를 영구적으로 획득합니다",
    cost: 1e25,
    formatCost,
  },
