...
<li>iOS 버전 링크 추가</li>
<li>모든 AD 자동 구매기에 최대 구매/낱개 구매 전환 버튼 추가</li>
</ul>
<br>
<b>문구 변경:</b><br>
<ul>
...
<b>추가 사항:</b><br>
<ul>
<li>사용한 TT를 오토메이터 화폐로 추가</li>
<li>천상 글리프 외형 세트에 다섯 번째 셀레스티얼의 문양 추가</li>
</ul>
<br>
<b>소규모 UI 변경:</b><br>
<ul>
...
<li>글리프 외형에서 세 번째 셀레스티얼 문양의 크기 조정</li>
<li>ID 및 TD 구매 버튼이 축소되는 빈도 감소</li>
<li>IC 보상을 아직 완료하지 않았어도 항상 표시</li>
<li>도전과제 118을 해금하고 차원 희생 자동 구매기가 켜져 있으면 희생 버튼 비활성화</li>
</ul>
<br>
<b>버그 수정:</b><br>
<ul>
...
<li>두 번째 셀레스티얼과 특전 상점의 해금 순서 교체</li>
<li>시간 연구 131에 추가 효과 부여</li>
<li>자동 구매기 입력값을 Enter 키로 적용 가능</li>
<li>도전과제 118의 보상이 차원 희생 자동 구매기를 개선</li>
<li>글리프 프리셋 설정의 기본값을 포함/증가로 변경</li>
<li>글리프 재활용 시 현실 자동 구매기에 설정한 글리프 레벨을 기준으로 효과 검사</li>
<li>허수 머신 40 업그레이드를 모방한 일곱 번째 셀레스티얼 업그레이드 추가</li>
<li>탭 설정 창에 모든 탭 표시 버튼 추가</li>
<li>조건 잠금으로 자동 EC가 비활성화됐을 때 안내 표시 추가</li>
...
<li>허수 머신 1000 업그레이드 조건을 5초 이내 영원으로 변경</li>
<li>EC에서 나갈 때 연구 트리가 자동으로 재분배되도록 변경</li>
<li>혼란을 일으키던 일곱 번째 셀레스티얼의 반복 구매 가능한 TP 업그레이드 비활성화</li>
<li>위 업그레이드 삭제에 맞춰 다섯 번째 막대의 세 번째 이정표 재조정</li>
<li>여러 소규모 문구 변경</li>
</ul>
<br>
<b>소규모 UI 변경:</b><br>
<ul>
<li>새 차원 자동 구매기 대량 구매 특전에 맞춰 특전 배치 조정</li>
...
<li>특정 자동 구매기 입력값에서 NaN이 표시되던 문제 수정</li>
<li>시작 특전이 없는 저장 파일에서 발생하던 일부 오작동 수정</li>
<li>시간 연구 192가 비활성화됐을 때 콘솔 오류를 내던 문제 수정</li>
<li>일곱 번째 셀레스티얼의 시간 팽창 창에서 EP를 얻지 못한다고 잘못 안내하던 문구 수정</li>
<li>오토메이터 연구 문자열의 !가 올바르게 해석되지 않던 문제 수정</li>
<li>원격 기계 공정 잠금이 활성화됐을 때 모든 TD 최대 구매 버튼이 오작동하던 문제 수정</li>
<li>내부 형식 변경으로 프리셋의 에파리그 글리프가 뒤섞이던 문제 수정</li>
<li>글리프 프리셋에서 레벨: 증가를 선택했을 때 가장 높은 레벨의 글리프를 고르지 않던 문제 수정</li>
<li>애니메이션을 켠 채 일곱 번째 셀레스티얼의 시간 팽창에 진입하면 잔재 수가 제대로 초기화되지 않던 문제 수정</li>
<li>EC! 기능과 연구 트리 재분배를 동시에 사용할 때 EC의 TT 비용이 잘못 계산되던 문제 수정</li>
<li>완전 완료 시 상수 데이터가 제대로 이어지지 않던 문제와 그 영향을 받은 저장 파일의 데이터 이전 수정</li>
<li>디자인 테마에서 중복 표시되던 도전과제 페이지 문구 제거</li>
...
<b>새로운 기능:</b><br>
<ul>
<li>시간 연구 가져오기 문자열에 EC가 포함되고 ‘!’로 끝나면 가져오는 즉시 해당 도전에 진입</li>
<li>시간 팽창과 아마겟돈 시 글리프 재분배 단축키 추가</li>
<li>Shift를 누른 채 현실 버튼을 클릭하면 설정과 관계없이 글리프 선택 창 표시</li>
<li>특전 배치 3종 추가(정사각형, 가로 격자, 시작점과의 거리)</li>
<li>일부 현실 및 허수 업그레이드에 ‘업그레이드 잠금’을 설정하여 해금 조건을 실패하게 만드는
수동·자동 행동을 자동으로 방지</li>
<li>글리프 필터 설정을 텍스트로 가져오고 내보내는 기능 추가</li>
<li>예정된 선택지가 모두 필터에 거부될 경우, 가능해지는 즉시 자동 현실을 실행하도록 설정 가능
(자동 구매기가 켜져 있어야 함)</li>
...
<li>보상이 있는 도전과제의 왼쪽 아래에 추가 아이콘 표시</li>
<li>무한 및 영원 자동 구매기의 ‘시간’ 또는 ‘최고 기록의 X배’ 모드에서 다음 명성 초기화 시점을
설정 상자의 상태 문구로 표시</li>
<li>현재 현실에서 한 번이라도 해금한 영원 도전은 완료 전에 다른 도전을 해금하더라도 EC 탭에 계속 표시</li>
<li>초기 몇 차례의 현실에서 자원 따라잡기 창에 더 자세한 정보 표시</li>
<li>영원 업그레이드 2 특전의 영향을 받는 업그레이드 비용 문구를 더 정확하게 표시</li>
<li>글리프를 선택하지 않고 실수로 현실을 실행할 수 없도록 변경. 선택 전에는 확인 옵션이 표시되지 않음
(희생 해금 후 선택 창을 비활성화하면 여전히 게임이 무작위로 선택)</li>
<li>최근 명성 초기화의 현실 기록에서 필요할 때 iM 표시</li>
...
<li>보상을 받을 수 있는데 현실 초기화만 하려 할 경우 더 강한 경고 표시</li>
...
<li>네 번째 셀레스티얼 탭에서도 저주받은 글리프 제작 가능</li>
<li>특이점 이정표 버튼의 빛나는 효과 비활성화 가능</li>
</ul>
<br>
<b>버그 수정:</b><br>
<ul>
<li>저장 슬롯 변경 시 IP/EP 획득률이 제대로 갱신되지 않던 문제 수정</li>
<li>시간 연구 프리셋의 이름이 중복되지 않도록 변경</li>
<li>시간 팽창 중 IP가 무한대 미만일 때 영원 버튼의 스타일이 잘못되던 문제 수정</li>
...
<li>일부 상황에서 첫 번째 셀레스티얼의 RM 기록이 잘못 추적되던 문제 수정</li>
<li>글리프 필터가 가끔 희귀도를 제대로 비교하지 않던 문제 수정</li>
<li>특정 상황에서 일곱 번째 셀레스티얼의 글리프 슬롯이 제대로 나타나거나 사라지지 않던 문제 수정</li>
<li>여섯 번째 셀레스티얼 아이콘의 정렬 문제 수정(@mrkrutaman 제공)</li>
...
<li>일반 도전 12에서 AD 탭이 특별하게 작동</li>
<li>항목이 하나뿐이어도 ‘도전과제’, ‘시간 연구’ 같은 일반 범주를 열 수 있도록 변경</li>
<li>배수 탭의 게임 속도에는 DT가 주는 감소 효과가 적용되지 않도록 변경</li>
...
<li>오프라인 상태에서 조건을 충족해도 비밀 도전과제 46을 정상 획득</li>
<li>실제 시간을 저장해도 자동 구매기가 틱을 진행</li>
<li>글리프 탭에서 셀레스티얼 현실을 나가려 할 때 창이 오작동하고 게임이 종료되던 문제 수정</li>
<li>스피드런의 인앱 구매 표시를 더 일관되게 갱신</li>
<li>증폭 때문에 현실 버튼의 예상 RM 값이 잘못 표시되던 문제 수정</li>
...
<li>증폭된 현실 후 글리프 난수 시드가 진행되지 않던 문제 수정</li>
</ul>
...
<li>문구가 겹치지 않도록 셀레스티얼 탐색의 V 항목 위치 조정</li>
<li>AMOLED 테마에서 크레딧 스크롤에 올바른 테마 적용</li>
<li>블랙홀 해금 시 도전과제 142가 해금되지 않던 문제 수정</li>
<li>현실 글리프 외형의 색상이 제대로 처리되지 않던 문제 수정</li>
...
<b>주요 변경 사항:</b><br>
<ul>
<li><b>2~21번째 현실의 글리프 난수 생성을 완전히 개편했습니다.</b> 새 방식은 해당 현실에서 효과가
더 고르게 나오도록 합니다. 연속된 현실 5회마다 모든 글리프 유형이 정확히 4번씩 등장하며,
각각의 효과는 그 네 선택지 중 <i>최소 한 번</i> 반드시 나타납니다.
</li>
<li>위 변경의 두 가지 영향으로 2효과 글리프가 더 흔해졌고(복제와 시간 팽창은 약 30%, 나머지 셋은 약 140%),
이 버전을 처음 불러올 때 <i>현재</i> 현실의 글리프 선택지가 달라질 수 있습니다.</li>
<li>스피드런 저장을 시작할 때 게임 완료 후 원래 이어지는 모든 통계가 정상적으로 유지</li>
<li>이전 스피드런 기록을 저장 파일에 보관하고 새 하위 탭에서 비교 가능</li>
<li>아직 현실을 실행하지 않았다면 스피드런 중 게임 내에서 글리프 난수 시드 수정 가능</li>
...
<b>새 편의 기능:</b><br>
<ul>
<li>최종 도전과제 획득 후 통계의 실제 시간 일시정지</li>
<li>특전 트리의 조작 반응성 전반 개선</li>
<li>기본 특전 트리 배치 2종 추가(Android 버전 격자와 블랙홀)</li>
<li>영원 도전 자동 구매기 특전 보유 시 영원 자동 구매기가 즉시가 아닌 최대 완료 횟수에서만 작동</li>
...
<li>이번 현실에서 복제자 최대치와 팽창된 시간에 도달할 예상 시간 추가</li>
...
<li>일부 테마의 자동 구매기 입력 상자 대비 개선</li>
<li>통계 탭의 현실 제목에 일곱 번째 셀레스티얼 관련 통계도 표시</li>
<li>유물 파편 희귀도 보너스와 저주받은 글리프의 작동 방식 명확화</li>
<li>관련 상황에서 ID8에 초당 % 표시 추가</li>
<li>오프라인 진행 항목에 TT 추가</li>
<li>플레이 방법의 블랙홀 항목에 비용 증가 방식 추가</li>
<li>연속체 활성화 시 AD 구매 버튼을 여섯 번째 셀레스티얼 스타일로 변경</li>
...
<li>일부 상황에서 AD 자동 구매기 설정을 변경할 수 없던 문제 수정</li>
...
<li>‘정보의 덧없음’이 RM 조건을 잘못 계산하던 문제 수정</li>
<li>그 밖의 여러 소규모 버그 수정</li>
</ul>
`
  },
...
<b>새 편의 기능:</b><br>
<ul>
<li>5배 EP 구매가 항상 TD 자동 구매기보다 먼저 작동</li>
<li>자동 현실에 시간 및 유물 파편 모드 추가</li>
<li>게임 완전 완료를 넘어선 총 시간 추적 추가</li>
<li>잘못된 게임 동작 가능성을 줄이도록 일부 플레이어 속성의 기본값 변경</li>
<li>연구 탭에서 생성/총 TT의 표시 순서를 바꾸는 옵션 추가</li>
...
<li>일곱 번째 셀레스티얼에서 장착할 수 없는 글리프 안내 문구 추가</li>
<li>여러 곳에서 게임 시간/실제 시간의 작동 방식을 더 명확하게 설명</li>
<li>시간 연구 21의 효과를 배수로 표시</li>
<li>현실 업그레이드 버튼의 대비 향상</li>
<li>‘도전과제 조건 불필요’ 특전이 더 일관되게 작동하도록 변경</li>
<li>크레딧의 일부 항목 갱신</li>
<li>이번 현실의 최대 DT 추가</li>
<li>일곱 번째 셀레스티얼에서 여러 요소가 시각적으로 비활성화되지 않던 문제 수정</li>
...
</li><li>비밀 도전과제 12와 42의 예외 상황 수정
</li><li>오프라인 진행에서 다섯 번째 셀레스티얼의 세 번째 기억 이름이 잘못 표시되던 문제 수정
</li><li>시간 팽창 상태의 플레이가 EP를 주지 않거나 기록에 남지 않던 문제 수정
</li><li>일곱 번째 셀레스티얼에서 복제자 시간이 잘못되던 문제 수정
</li><li>잠긴 자동 구매기를 단축키로 변경할 수 있던 문제 수정
</li><li>일곱 번째 셀레스티얼에서 연속체 플레이 방법 항목이 사라지던 문제 수정
</ul>
`
  },
  {
...
<b>밸런스 변경:</b><br>
<ul>
<li>EC4의 무한 횟수 조건이 더 느리게 증가(단계당 5천만 → 2천5백만)</li>
<li>EC11의 모든 단계 목표를 e50만큼 감소</li>
<li>세 번째 셀레스티얼 힌트의 가시성 개선(진행도를 항상 표시하고 10배 빠르게 누적)</li>
<li>블랙홀 자동 펄스가 99%에서 항상 충전을 강제하며 충전 비율 조정 기능 제거</li>
<li>가속도가 2.5배 빠르게 증가</li>
<li>최종 특이점 이정표 감소(8e45 → 2.5e45)</li>
<li>스피드런 시작 시 도전과제 35와 76도 획득</li>
</ul>
<br>
...
<li>자동 EC 일시정지 시 다음 도전을 완료하지 않고 보유</li>
</ul>
<br>

<b>버그 수정:</b><br>
<ul>
<li>모던 메트로 테마에 올바른 AD 색상 적용</li>
<li>클라우드 저장 충돌 옵션 버튼이 정상 작동</li>
<li>‘10개 구매’ 배수를 항상 표시</li>
<li>무한 돌파 전 단축키 사용 시 빅 크런치 창이 나타나지 않도록 수정</li>
<li>다음 EC 보상이 최대치에서도 ‘다음:’을 표시</li>
<li>최대 완료 후 EC 조건이 더 이상 증가하지 않도록 수정</li>
<li>일부 상황에서 동료 글리프가 글리프로 계산되던 문제 수정(레이틸라의 엔트로피, 탐색, 도전과제)</li>
<li>블랙홀 관련 도전과제가 표시 간격/지속 시간에 반영되지 않던 문제 수정</li>
<li>다섯 번째 셀레스티얼 시간이 실제 시간 저장을 반영</li>
<li>불안정화 후 여섯 번째 셀레스티얼의 문구가 제대로 갱신</li>
</ul>
<br>

<b>소규모 변경:</b><br>
<ul>
<li>클라우드 충돌 감지 개선(영원 초반의 영원 횟수 및 시간 팽창의 최대 DT)</li>
<li>클라우드 저장 시 Google 정보를 숨기는 기능 추가</li>
<li>플레이 방법에 ‘자주 쓰는 약어’ 추가</li>
<li>최대 복제자 문구 추가</li>
<li>명성 초기화 버튼의 IP/분 및 EP/분 숨김 기준 감소</li>
<li>완전히 완료한 EC 연구에 윤곽선 추가</li>
<li>외형에 세 번째 셀레스티얼 아이콘 추가</li>
...
<li>EP 기반 자동 구매기보다 영원 업그레이드 2 특전을 항상 먼저 확인</li>
<li>다른 셀레스티얼 현실에서 일곱 번째 셀레스티얼에 진입할 수 있던 문제 수정</li>
<li>일곱 번째 셀레스티얼 초반에 자동 구매기를 변경할 수 없던 문제 수정</li>
<li>영원 도전 자동 구매기 특전이 최대 IP 대신 현재 IP를 사용하던 문제 수정</li>
<li>다른 저장 파일을 불러올 때 ‘새 항목!’ 알림 제거</li>
<li>IC5에서 일반 도전 9 효과가 틱스피드 비용에 잘못 적용되던 문제 수정</li>
</ul>
<br>
...
<li>IP 공식 관련 잘못된 문구 수정</li>
<li>도전과제 156이 생성된 TT에만 적용됨을 명확화</li>
<li>조금 오래된 플레이 방법 항목 갱신</li>
<li>플레이 방법의 글리프 필터 및 연금술에 추가 정보 기재</li>
<li>복제 글리프 효과의 DT 배수가 매우 작은 수를 사용하지 않도록 문구 변경</li>
<li>특전 문구의 일관성 개선</li>
<li>표기법이 적용되지 않았거나 숫자 숨김 설정을 따르지 않던 곳 수정</li>
<li>여러 구두점 불일치 수정</li>
<li>갱신 속도보다 짧아도 빅 크런치 자동 구매기가 항상 간격을 표시</li>
<li>EC8의 ID 구매 횟수를 페이지 위쪽으로 이동</li>
<li>복제자가 적을 때 타이머에 ‘약’ 표시 추가</li>
<li>AG 버튼 문구에 특정 자원의 초기화를 막는 도전과제 반영</li>
...
<li>IC3과 현실 업그레이드의 일부 문구 넘침 문제 수정</li>
<li>현실 알림 문구 개선</li>
...
<li>도전 및 도전과제 ID 추가(옵션에서 끌 수 있음).</li>
<li>진행 표시줄 정보 추가(EC 목표, TP 획득까지의 시간 팽창 진행도).</li>
<li>자동 구매기의 동적 수량을 끄는 옵션 추가.</li>
<li>시간 팽창이나 도전처럼 현재 진행 중인 무한/영원/현실 유형 표시.</li>
...
<li>자동 구매기 하위 탭을 새 자동화 탭으로 이동하고 무한 차원 및 복제자 자동 구매기 같은 추가 제어 기능 배치.</li>
<li>통계 하위 탭에 구역 추가.</li>
<li>하단 링크를 새 플레이 방법 및 게임 정보 창으로 이동.</li>
<li>일부 도전과제 이름과 이미지 변경.</li>
<li>일부 비밀 도전과제 이름과 조건 변경.</li>
...
<li>IP/EP가 e50을 넘으면 빅 크런치/영원 버튼에 색상 표시. 현재 보유량보다 적게 얻으면 빨강,
  비슷하면 흰색, 현재 보유한 IP/EP보다 더 많이 얻으면 초록색.</li>
...
새 업그레이드 및 기술적 동작 개선:
<ul>
<li>무한 도달 전에도 반물질로 자동 구매기를 해금할 수 있지만 해당 도전을 완료한 뒤에만 업그레이드 가능.</li>
<li>오프라인에서 모두 최대 구매를 사용하지 않은 최고 IP/분의 50%를 제공하는 1e3 IP 업그레이드 추가.</li>
<li>오프라인에서 최고 EP/분의 25%를 제공하는 새 영원 이정표 추가.</li>
<li>오프라인에서 무한 및 영원 횟수를 주는 이정표 2개 추가.</li>
<li>‘가장 빠른 무한에 따른 무한 포인트 생성’ 업그레이드가 모든 IP 배수를 반영.</li>
...
<li>설정과 관계없이 EC 목표에 도달하면 영원 자동 구매기 작동.</li>
</ul>
<br>
...
<li>도전과제마다 반물질 차원에 추가 1.03배 배수 제공.</li>
<li>빅 크런치 자동 구매기의 초기 간격을 절반으로 줄여 최대 업그레이드에 필요한 IP도 절반으로 감소하고,
  다른 자동 구매기의 초기 간격도 크게 감소.</li>
<li>500 IP 업그레이드의 비용을 300 IP로 변경.</li>
<li>Nicolas Cage.</li>
<li>영원 20회 이정표를 영원 8회로 이동.</li>
<li>1e6000 이후 시간 차원의 비용 증가 강화.</li>
<li>시간 연구 83에 절대 상한 적용.</li>
<li>EC10의 5회 미만 완료 보상 하향(5회 완료 보상은 동일).</li>
<li>시간 팽창 해금 조건을 총 TT 13000개에서 12900개로 감소.</li>
<li>시간 팽창의 TP 획득량을 도달한 최고 AM 기준으로 계산.</li>
<li>시간 팽창 해금 연구 구매에 23번째 줄 연구 구매를 요구.</li>
<li>IC1의 조건 변경(도전을 직접 실행하는 대신 도전 제한만 적용).</li>
<li>IC2 해금 조건을 1e5000에서 1e10500으로, IC6은 1e20000에서 1e22500으로 변경.</li>
<li>IC1 목표를 1e850에서 1e650으로 변경.</li>
<li>IC5 목표를 1e11111에서 1e16500으로 변경.</li>
<li>‘이걸 하향하는 걸 깜빡했네’ 보상 추가(1차 AD 5% 배수).</li>
...
<li>‘최대 과부하’ 조건을 1e300 IP/분에서 1e300 IP로 변경.</li>
...
<li>‘이제 시간 팽창으로 생각하는군!’ 조건을 1e600 EP에서 1e260000 AM으로 변경.</li>
<li>‘널 없애려면 이걸 해야 한다니’ 조건을 1e20000에서 1e26000으로 변경.</li>
<li>도전과제 41을 ‘DLC 필요 없음’, ‘무한 업그레이드 16개 구매’, ‘새 무한 업그레이드 2개 해금’으로 변경.</li>
<li>‘죽음 0회’ 위치를 43에서 64로 변경.</li>
<li>‘100만은 큰 수야’ 위치를 64에서 77로 변경.</li>
<li>‘반물질 표가 뒤집혔네’ 위치를 77에서 43으로 변경.</li>
<li>도전과제 101과 117의 위치 교체.</li>
<li>도전과제 113과 124의 위치 교체.</li>
...
버그 수정:
<ul>
<li>EC8에서 ID 및 복제자 자동 구매기 버튼 숨김.</li>
<li>다음 차원 희생 배수에 일반 도전 8의 효과가 제대로 표시되지 않던 문제 수정.</li>
<li>IC5의 비용 증가가 두 번 적용되던 문제 수정.</li>
<li>반전 테마가 깨지던 문제 수정.</li>
<li>게임 초기화 시 비밀 도전과제가 해금되던 문제 수정.</li>
<li>EC를 5회 완료한 뒤 잘못된 목표가 표시되던 문제 수정.</li>
<li>총 은하 수가 3개 미만이면 반물질 은하가 아닌 은하가 틱스피드에 적용되지 않던 문제 수정.</li>
<li>고정된 무한에 도달했거나 도전 중인데도 한 틱 동안 무한보다 많은 반물질을 생산할 수 있던 문제 수정.</li>
<li>표기법을 변경할 때 자동 구매기의 숫자 형식이 제대로 갱신되지 않던 문제 수정.</li>
<li>EC8에서 자동 구매기가 켜져 있으면 무한 차원 해금 즉시 자동 구매되던 문제 수정.</li>
<li>불러오기/가져오기 후 복제자 업그레이드 자동 구매기가 꺼짐으로 잘못 표시되던 문제 수정.</li>
<li>복제자 간격 업그레이드가 최대 속도보다 낮은 값으로 업그레이드된다고 표시하던 문제 수정.</li>
<li>무한력이 0일 때 무한 차원 배수가 0배로 표시되던 문제 수정.</li>
<li>자동 구매기로 허용 횟수보다 무한을 한 번 더 실행해 EC4를 완료할 수 있던 문제 수정.</li>
<li>차원 외 자동 구매기의 간격 감소 비용이 표기법을 따르지 않던 문제 수정.</li>
<li>‘무한으로!’ 도전과제 보상이 작동하지 않던 문제 수정.</li>
...
<li>‘무한의 4.3333분’ 도전과제 해금 알림이 ‘무한의 1분’으로 표시되던 문제 수정.</li>
...
<li>‘눈 깜짝할 사이’ 도전과제 이미지가 GIF였던 문제 수정.</li>
<li>‘친구, 네가 무한을 좋아한다고 들었어’ 도전과제 해금 조건이 제대로 검사되지 않던 문제 수정.</li>
<li>시간 연구 11에 표시되는 배수 공식이 잘못되던 문제 수정.</li>
<li>차원 희생 및 차원 가속 자동 구매기가 자동 구매기 간격을 따르지 않던 문제 수정.</li>
<li>현실 링크가 춤추는 사람 영상에 불과했던 문제 수정.</li>
<li>그 밖의 여러 버그 수정.</li>
`
  },
  {
...
<li>EC10 보상 하향. ((무한 횟수 * EC10 완료 횟수 * 0.000002+1) >
(무한 횟수 ^ 0.9 * EC10 완료 횟수 * 0.000002+1))</li>
...
<li>EC1의 단계별 해금 조건을 영원 25,000회에서 20,000회로 감소.</li>
<li>1e1300 이후 TD 비용 증가 강화(기존 증가에 추가 적용).</li>
<li>은하 800개 이후 추가 은하 비용 증가 적용.</li>
<li>영원 포인트 배수를 한 번에 최대 구매하는 버튼 추가.</li>
<li>오프라인 진행 처리 속도 약 5배 향상 및 자동 구매기 시뮬레이션 추가(오프라인 진행은 여전히 1,000틱이
...
<li>EC3 설명에 차원 희생 비활성화를 명시.</li>
<li>자동 구매기 입력에 쉼표와 지수 표기법 지원.</li>
<li>EP/IP 배수 구매 시 자동 구매기 입력값이 1,000을 넘으면 항상 형식 적용.</li>
<li>자동 IP 배수와 자동 복제자 은하 전환 버튼의 크기·위치를 다른 자동 전환 버튼에 맞게 조정.</li>
<li>EC12 안에서 총 플레이 시간이 정상 속도로 증가.</li>
<li>EC12 안에서 가장 빠른 무한 시간이 정상 갱신.</li>
<li>시간 정리 구매 배경 너비 20픽셀 증가.</li>
<li>시간 연구 133의 문구 명확화.</li>
<li>도전과제 설명에 누락된 마침표 추가.</li>
<li>차트 성능 개선(설정이 너무 높으면 여전히 느릴 수 있음).</li>
<li>EC11/12 연구를 구매한 상태에서도 연구 201을 살 수 있지만 다른 경로는 구매 불가.</li>
<li>연구 131 구매 시 복제자 은하 자동 구매기를 끄는 대신 비활성 상태로 표시.</li>
<li>연구 201 보유 중 Shift를 사용해 다른 분기 구매 가능.</li>
<li>영원 6회 초과 시 클릭이나 단축키로 은하를 수동 최대 구매.</li>
<li>Shift를 누른 채 구매하면 차원 가속과 은하를 하나씩 구매.</li>
<li>EC7을 한 번 이상 완료하면 ID8에 변화율 표시.</li>
<li>형식화된 시간 값에 마지막 쉼표 추가.</li>
<li>문구 넘침 방지를 위해 차원 희생 버튼 너비 40픽셀 증가.</li>
<li>모든 탭의 영원/무한 포인트 표시 너비 30픽셀 증가.</li>
<li>통계 및 도전과제 탭 버튼을 가리지 않도록 빅 크런치 버튼을 위로 이동.</li>
<li>HTML 배치가 흔들리지 않도록 영원 및 무한 버튼을 안쪽으로 이동.</li>
<li>일부 하단 영역 위치 수정.</li>
<li>뉴스의 ‘Dimensional Sacrifice’ 오타 수정.</li>
<li>TD가 실제로는 구매당 4배인데 2배로 표시되던 문제 수정.</li>
<li>시간 연구 51이 표기법을 따르지 않던 문제 수정.</li>
<li>무한 도전 탭이 항상 표시되던 문제 수정.</li>
<li>특정 상황에서 자동 복제자 은하 전환 버튼이 좌우로 1픽셀 흔들리던 문제 수정.</li>
<li>EC7에서 7차 차원 변화율이 ID1을 반영하지 않던 문제 수정.</li>
<li>EC12를 5회 완료한 뒤 0.0초가 필요하지만 0.1초로 표시되던 문제 수정.</li>
<li>일부 상황에서 틱스피드 요소가 제대로 숨겨지지 않던 문제 수정.</li>
<li>구매한 영원 도전 해금 연구가 어두운 테마에서 진한 보라색 대신 회색으로 표시되던 문제 수정.</li>
<li>영원 30회 이정표가 있어도 영원 시 5~8차원이 숨겨지던 문제 수정.</li>
...
<li>ID 자동 구매기가 꺼져 있어도 해금 즉시 ID를 구매하던 문제 수정.</li>
<li>22번째 줄까지 그린 연구 트리 가지가 중앙에서 벗어나던 문제 수정.</li>
<li>가져오기 후 EP/분 및 IP/분 최고치가 제대로 갱신되지 않던 문제 수정.</li>
<li>가져오기 후 무한 차원 자동 구매기가 제대로 숨겨지지 않던 문제 수정.</li>
<li>가져오기 후 IP 배수 자동 구매기가 제대로 숨겨지지 않던 문제 수정.</li>
<li>가져오기 후 빅 크런치 모드 변경 옵션이 제대로 숨겨지지 않던 문제 수정.</li>
<li>가져오기 후 최대 은하 구매 간격 설정이 제대로 숨겨지지 않던 문제 수정.</li>
<li>가져오기 후 복제자 은하 자동 구매기가 제대로 숨겨지지 않던 문제 수정.</li>
<li>가져오기 후 영원 확인 옵션이 제대로 숨겨지지 않던 문제 수정.</li>
<li>가져오기 후 복제자 업그레이드 자동 구매기가 제대로 숨겨지지 않던 문제 수정.</li>
<li>가져오기 후 갱신 속도가 바뀌지 않던 문제 수정.</li>
<li>가져오기 후 차트 선 색상이 제대로 갱신되지 않던 문제 수정.</li>
<li>도전과제 이미지 오른쪽과 아래쪽이 4픽셀 잘리던 문제 수정.</li>
<li>‘친구, 네가 무한을 좋아한다고 들었어…’에 이전 무한의 1e300배만 필요하던 문제 수정.</li>
<li>자동 구매기 속도 2배 무한 돌파 업그레이드가 있어도 자동 희생 간격이 0.10초로 표시되던 문제 수정.</li>
...
<li>도전과제 이미지를 드래그해 선택할 수 있던 문제 수정.</li>
...
<li>‘대중음악’ 도전과제 보상 추가: ‘복제자 은하가 복제자를 1로 초기화하는 대신 1.79e308로 나눕니다.’</li>
<li>‘9000을 넘었어’ 도전과제 보상 추가: ‘희생 시 차원이 초기화되지 않습니다.’</li>
<li>‘마치 엉덩이를 포식하듯’ 도전과제 보상 추가: ‘이번 무한에서 보낸 시간에 따라 IP 배수 증가.’</li>
<li>‘널 없애려면 뭘 해야 하지’ 도전과제 보상 추가: ‘보유한 연구 수에 따라 시간 차원 배수 증가.’</li>
<li>‘무한’ 표기법 추가.</li>
<li>‘괄호’ 표기법 추가.</li>
<li>시간 연구 트리 가져오기/내보내기 시스템 추가.</li>
<li>영원 버튼에 EP/분과 최고 EP/분 표시 추가.</li>
<li>영원 단축키 추가.</li>
<li>테마 선택을 도와주는 무언가 추가.</li>
<li>인앱 구매 몇 가지 추가.</li>
<li>‘모든 경로에서 얻는 IP 2배’ 인앱 구매 비용을 50에서 40으로 감소.</li>
</ul>
<br>
<b>소규모 변경:</b><br>
<ul>
...
<li>EP 배수 구매에 여러 번 클릭이 필요하던 문제 수정.</li>
<li>게임에서 유령 제거. 성가셨음.</li>
<li>EC7에서 ‘오래가는 관계’ 도전과제를 얻을 수 있던 문제 수정.</li>
<li>의도대로 원숭이가 더 이상 인간을 먹지 않음.</li>
<li>EC7 보상이 -1로 표시되던 문제 수정.</li>
<li>수집가의 펜던트 아이템 획득률 20% 증가.</li>
<li>EC4의 무한 조건이 0 미만이 될 수 있던 문제 수정.</li>
<li>초월이 주는 고대 영혼 감소.</li>
<li>첫 영원 후 자동 구매기 대량 구매 설정 표시가 갱신되지 않던 문제 수정.</li>
<li>릭롤 수정. 이제 제대로 작동하지 않음.</li>
<li>EP 배수의 지수가 1.79e308을 넘으면 깨지던 문제 수정.</li>
...
<li>드물게 오프라인 진행 창에서 시간 조각이나 무한력을 ‘NaNeInfinity’만큼 얻었다고 표시하던 문제 수정.</li>
...
<li>EC4 문구를 ‘X 미만’에서 ‘X 이하’로 변경(원래부터 이렇게 작동했으며 문구만 수정).</li>
<li>당나귀 속도를 낮춰 이제 실제로 잡을 수 있음.</li>
<li>EC2 보상 문구를 ‘무한 차원에 적용’에서 ‘1차 무한 차원에 적용’으로 변경
...
<li>전리품 상자 추가.</li>
<li>전리품 상자 제거.</li>
<li>도전과제 설명에 누락된 여러 마침표 추가.</li>
<li>이번 영원에서 보낸 시간에 누락된 마침표 추가.</li>
<li>생성 횟수 증가 비용을 신의 힘 50에서 60으로 증가.</li>
<li>‘자동 구매기가 2배 빠르게 작동합니다.’ 업그레이드에 누락된 공백 추가.</li>
...
<li>영원 포인트 배수를 구매하면 영원 자동 구매기 수치에 5를 곱하도록 변경.</li>
...
<li>영원 7회 및 25회 이정표 작동 속도 대폭 향상.</li>
...
<li>이정표 페이지를 2열로 변경.</li>
<li>표준 표기법 지원을 e3e18까지, 문자/암 표기법은 거의 무한히 확장.</li>
<li>자동 구매기 입력에서 표준, 문자, 로그 표기법 지원.</li>
<li>‘죽음 0회’ 설명에 ‘도전 중’ 추가.</li>
<li>도전과제의 대부분 큰 수를 선택한 표기법으로 표시.</li>
<li>‘신들의 선물’ 도전과제 보상 하향.</li>
<li>EP로 시간 정리를 구매하려면 시간 차원 1개 이상 요구.</li>
<li>첫 영원 후 시간 차원 탭으로 이동.</li>
<li>시간 차원 가격에 소수점 두 자리 표시.</li>
<li>매우 작은 수의 틱 간격 감소 문구 형식 개선.</li>
<li>자동 무한 시점을 기록하고 오프라인일 때 해당 플레이의 IP/분에 따라 IP를 수동 획득
(무한 돌파 전만 적용).</li>
<li>시간 연구 171을 소급 적용. 재분배와 같은 플레이에서 장기 플레이에 들어가면 생산량이 예상보다 낮던 문제 해결.</li>
<li>모두 최대 구매로 차원을 살 때 도전과제를 주지 않던 문제 수정.</li>
...
<li>최근 영원 10회의 평균이 EP/X가 아닌 IP/X로 표시되던 문제 수정.</li>
<li>빅 크런치 자동 구매기가 ‘지난 크런치 이후 X배’라고 잘못 표시하던 문제 수정.</li>
...
<li>가져오기 후 영원 이정표 클래스가 잘못 설정되던 문제 수정.</li>
<li>가져오기 후 영원 자동 구매기, 희생 자동 구매기, 시간 차원 탭, 복제자가 제대로 숨겨지지 않던 문제 수정.</li>
...
<li>차원 가속 비용이 8차 차원이 되기 전까지 자동 구매기가 비용을 무시하던 문제 수정.</li>
...
<li>다양한 자동화를 제공하는 영원 이정표</li>
<li>영원 업그레이드</li>
<li>시간 차원</li>
<li>복제자</li>
<li>Omsi가 만든 테마 추가</li>
<li>단축키 비활성화 옵션</li>
<li>무한 돌파 후 현재 IP/분</li>
<li>무한 도전 기록</li>
<li>최근 영원 10회</li>
<li>IP 배수 비용의 자릿수 1단계 감소.</li>
<li>도전과제 3줄 추가</li>
...
<li>StrangeTim이 저장 문자열 크기를 줄이도록 도전과제 코드 재구성.</li>
...
<li>새 도전과제 8개와 도전과제 보상 추가.</li>
<li>무한 도전: 2차 무한 차원부터 당시 최종 콘텐츠 이후까지 이어지는 추가 도전.</li>
<li>메인 화면 UI 갱신: 이제 어디서나 IP 표시.</li>
<li>단축키: C 빅 크런치, M 모두 최대 구매, S 차원 희생, D 차원 이동/가속,
G 반물질 은하, 1~8 해당 차원 10개 구매, A 자동 구매기 전환.</li>
...
<li>새 도전과제 8개.</li>
<li>자동 구매기 가격과 시간을 재작업하고 사용한 포인트 전액 환불.</li>
<li>자동 구매기를 0.1초보다 빠르게 업그레이드 가능. 간격이 지나면 구매 가능할 때까지 기다렸다가 즉시 구매.</li>
<li>자동 차원 가속, 은하, 빅 크런치에 입력 상자 추가.</li>
<li>여러 도전과제에 고유 보상 추가.</li>
<li>은하 0개일 때 틱스피드 11% 제공.</li>
<li>은하 2개 이후 효율 감소 적용. 보상으로 ‘감자보다 빠르게’를 쉽게 변경.</li>
<li>성능을 개선하고 게임을 초당 20회 갱신. 자동 구매기 최대 속도에는 영향 없음.</li>
<li>세션 사이에 자동 구매기 설정 저장.</li>
