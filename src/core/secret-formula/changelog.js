...
<li>iOS 버전 링크 추가</li>
<li>모든 AD 자동구매기에 최대 구매/낱개 구매 전환 버튼 추가</li>
</ul>
<br>
<b>문구 변경:</b><br>
<ul>
...
<li>혼란을 일으키던 일곱 번째 천상체의 반복 구매 가능한 TP 업그레이드 비활성화</li>
...
<li>일곱 번째 천상체의 시간 팽창 창에서 EP를 얻지 못한다고 잘못 안내하던 문구 수정</li>
...
설정 상자의 상태 문구로 표시</li>
<li>현재 리얼리티에서 한 번이라도 해금한 영원 도전은 완료 전에 다른 도전을 해금하더라도 EC 탭에 계속 표시</li>
...
<li>최근 명성 초기화의 리얼리티 기록에서 필요할 때 iM 표시</li>
...
<li>일부 상황에서 첫 번째 천상체의 RM 기록이 잘못 추적되던 문제 수정</li>
...
<li>증폭 때문에 리얼리티 버튼의 예상 RM 값이 잘못 표시되던 문제 수정</li>
...
<li>연속체 활성화 시 AD 구매 버튼을 여섯 번째 천상체 스타일로 변경</li>
...
<li>일부 상황에서 AD 자동구매기 설정을 변경할 수 없던 문제 수정</li>
...
<b>새 편의 기능:</b><br>
<ul>
<li>5배 EP 구매가 항상 TD 자동구매기보다 먼저 작동</li>
...
<li>EP 기반 자동구매기보다 영원 업그레이드 2 특전을 항상 먼저 확인</li>
<li>다른 천상체 리얼리티에서 일곱 번째 천상체에 진입할 수 있던 문제 수정</li>
<li>일곱 번째 천상체 초반에 자동구매기를 변경할 수 없던 문제 수정</li>
<li>영원 도전 자동구매기 특전이 최대 IP 대신 현재 IP를 사용하던 문제 수정</li>
...
<li>업적 156이 생성된 TT에만 적용됨을 명확화</li>
...
<li>AG 버튼 문구에 특정 자원의 초기화를 막는 업적 반영</li>
...
<li>IC3과 리얼리티 업그레이드의 일부 문구 넘침 문제 수정</li>
<li>리얼리티 알림 문구 개선</li>
...
<li>오프라인에서 최고 EP/분의 25%를 제공하는 새 영원 마일스톤 추가.</li>
...
<li>설정과 관계없이 EC 목표에 도달하면 영원 자동구매기 작동.</li>
</ul>
<br>
...
<li>빅 크런치 자동구매기의 초기 간격을 절반으로 줄여 최대 업그레이드에 필요한 IP도 절반으로 감소하고,
...
버그 수정:
<ul>
<li>EC8에서 ID 및 복제자 자동구매기 버튼 숨김.</li>
...
<li>EC8에서 자동구매기가 켜져 있으면 무한 차원 해금 즉시 자동 구매되던 문제 수정.</li>
...
<li>자동구매기로 허용 횟수보다 무한을 한 번 더 실행해 EC4를 완료할 수 있던 문제 수정.</li>
...
<li>EP/IP 배수 구매 시 자동구매기 입력값이 1,000을 넘으면 항상 형식 적용.</li>
...
<li>ID 자동구매기가 꺼져 있어도 해금 즉시 ID를 구매하던 문제 수정.</li>
...
<li>가져오기 후 IP 배수 자동구매기가 제대로 숨겨지지 않던 문제 수정.</li>
...
<li>‘마치 엉덩이를 포식하듯’ 업적 보상 추가: ‘이번 무한에서 보낸 시간에 따라 IP 배수 증가.’</li>
...
<li>EC7에서 ‘오래가는 관계’ 업적을 얻을 수 있던 문제 수정.</li>
