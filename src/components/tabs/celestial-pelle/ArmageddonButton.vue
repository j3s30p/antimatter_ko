...
<template>
  ...
  >
    <span v-if="isHeader">파멸한 현실에서는 벗어날 수 없습니다!<br></span>
    ...
    <br>
    현실 파편
    <span class="c-reality-shard-gain">{{ format(realityShardGain, 2, 2) }}</span>/초 ➜
    <span class="c-reality-shard-gain">{{ format(nextRealityShardGain, 2, 2) }}</span>/초
  </button>
</template>
