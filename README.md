...
**[AntimatterDimensions_KoreanPatch_1.0.0-rc.1.zip 다운로드](https://github.com/j3s30p/antimatter_ko/releases/download/v1.0.0-rc.1/AntimatterDimensions_KoreanPatch_1.0.0-rc.1.zip)**
...
3. 받은 ZIP의 압축을 풉니다.
4. 압축을 풀어 나온 `resources` 폴더를 게임 폴더에 그대로 끌어다 놓습니다.
...
- 라이선스와 출처는 이 저장소의 `ATTRIBUTION.md` 및 `licenses` 폴더에서 확인할 수 있습니다.
