...
| Early Modern UI | in progress | Dimension screen and navigation translated; rebuilt for tester recheck of shared UI |
...
| Help and catch-up documentation | in progress | H2P shell, game information, save/customization/offline, and initial Antimatter Dimension articles translated; later articles and catch-up pages remain |
| News ticker | not started | Final content batch |
...
- In-game installation: pending for this batch.
