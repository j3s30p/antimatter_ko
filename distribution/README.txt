...
3. ZIP의 압축을 풀면 resources 폴더 하나가 나타납니다.
4. resources 폴더를 게임 폴더에 그대로 끌어다 놓습니다.
5. app.asar를 덮어쓸지 묻는 창이 나타나면 덮어쓰기를 선택합니다.
...
라이선스 및 출처는 GitHub 저장소의 README.md와 ATTRIBUTION.md를 참조하세요.
Galmuri9의 SIL Open Font License 1.1 고지는 app.asar 내부에 포함되어 있습니다.
